        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <span className="text-2xl font-light tracking-tight">Schoolpal AI</span>
            </div>
            <p className="text-gray-300 leading-relaxed max-w-md">
              A non-profit initiative empowering K-12 students with free AI-powered offline tutoring. 
              Making quality education accessible to every child, everywhere.
            </p>
          </div>
